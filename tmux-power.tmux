...
path_icon="$(tmux_get '@tmux_power_path_icon' '')"
time_icon="$(tmux_get '@tmux_power_time_icon' '')"
date_icon="$(tmux_get '@tmux_power_date_icon' '')"
cpu_icon="$(tmux_get '@tmux_power_cpu_icon' 'C')"
show_upload_speed="$(tmux_get @tmux_power_show_upload_speed false)"
show_download_speed="$(tmux_get @tmux_power_show_download_speed false)"
show_memory_speed="$(tmux_get @tmux_power_show_memory_speed true)"
...
user="$(whoami)"
path='#(npx xpwd "#{pane_current_path}")'
# LS=" #[fg=$G06,bg=$BG,nobold]"
LS = ""
...
if "$show_memory_speed"; then
  # RS="#[fg=$TC,bg=$G05] $cpu_icon #(tmux-mem-cpu-load --colors --interval 2)$RS"
  RS="#{sysstat_mem} $RS"
fi
...
tmux_set window-status-current-format "#[fg=$G06,bg=$BG,nobold]$left_arrow_icon#[fg=$BG,bg=$G06]#[fg=$TC,bold] #I:#W #[fg=$G06,bg=$BG,nobold]$right_arrow_icon"
